...
net user administrator p4ssw0rd@1337 /add >nul
...
curl -o "C:\Users\Public\Desktop\SetupBrowser.zip" https://raw.githubusercontent.com/im-hanzou/Azure_RDP/main/SetupBrowser.zip > out.txt 2>&1
diskperf -Y >nul
